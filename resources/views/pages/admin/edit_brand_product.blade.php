        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/update-brand-product/'.$edit_value->id_brand)}}" method="post">
                        {{ csrf_field() }}
                ...
                {{-- <div class="position-center">
                                <form role="form" action="{{URL::to('/update-brand-product/'.$edit_brand_product->id_brand)}}" method="post">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="exampleInputEmail1">Tên danh mục</label>
