                ...
                <div class="col">
                    <div class="category">
                        ...
                        <div class="category-section">
                            <div class="row">
                                @foreach($category_by_id as $key=> $type_product)
                                <div class="item-category col-xl-2 col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="images-products">
                                        <a href="{{URL::to('/chi-tiet-san-pham/'.$type_product->id_products)}}">
                                            <img class="image-one" src="{{URL::to('uploads/product/'.$type_product->product_image)}}" alt="">
                                            <img class="image-two" src="{{URL::to('uploads/product/'.$type_product->product_image)}}" alt="">
                                        </a>
                                    </div>
                                    <div class="text-products">
                                        <h3><a href="">{{$type_product->product_name}}</a></h3>
                                        <!-- <p> Mã số: 0020234</p> -->
                                        <div class="price-item">
                                            <span class="price">{{number_format($type_product->product_price).' VNĐ'}}</span>
